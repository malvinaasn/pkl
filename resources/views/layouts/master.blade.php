      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
              ...
              <li>
                ...
                <ul class="menu">
                  <li><!-- start message -->
                    <a href="#">
                      <div class="pull-left">
                        <img src="{{ asset('frontend') }}/dist/img/malvina.jpg" class="img-circle" alt="User Image">
                      </div>
                      <h4>
                        Support Team
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="{{ asset('frontend') }}/dist/img/malvina.jpg" class="user-image" alt="User Image">
...
<!-- datepicker -->
<script src="{{ asset('frontend') }}/bower_components/bootstrap-datepicker/dist/bootstrap-daterangpicker.js"></script>
<!-- Bootstrap WYSIHTML5 -->
