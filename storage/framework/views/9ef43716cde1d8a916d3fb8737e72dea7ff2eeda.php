...
<head>
  ...
  <!-- Bootstrap 3.3.7 -->
  <link rel="stylesheet" href="<?php echo e(asset('frontend')); ?>/bower_components/bootstrap/dist/css/bootstrap.min.css">
  <!-- Font Awesome -->
  <link rel="stylesheet" href="<?php echo e(asset('frontend')); ?>/bower_components/font-awesome/css/font-awesome.min.css">
  <!-- Ionicons -->
  <link rel="stylesheet" href="<?php echo e(asset('frontend')); ?>/bower_components/Ionicons/css/ionicons.min.css">
  <!-- Theme style -->
  <link rel="stylesheet" href="<?php echo e(asset('frontend')); ?>/dist/css/AdminLTE.min.css">
  <!-- AdminLTE Skins. Choose a skin from the css/skins
       folder instead of downloading all of them to reduce the load. -->
  <link rel="stylesheet" href="<?php echo e(asset('frontend')); ?>/dist/css/skins/_all-skins.min.css">
  <!-- Morris chart -->
  <link rel="stylesheet" href="<?php echo e(asset('frontend')); ?>/bower_components/morris.js/morris.css">
  <!-- jvectormap -->
  <link rel="stylesheet" href="<?php echo e(asset('frontend')); ?>/bower_components/jvectormap/jquery-jvectormap.css">
  <!-- Date Picker -->
  <link rel="stylesheet" href="<?php echo e(asset('frontend')); ?>/bower_components/bootstrap-datepicker/dist/css/bootstrap-datepicker.min.css">
  <!-- Daterange picker -->
  <link rel="stylesheet" href="<?php echo e(asset('frontend')); ?>/bower_components/bootstrap-daterangepicker/daterangepicker.css">
  <!-- bootstrap wysihtml5 - text editor -->
  <link rel="stylesheet" href="<?php echo e(asset('frontend')); ?>/plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.min.css">
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index2.html" class="logo">
      ...
      <span class="logo-lg"><b>Covid</b>Info</span>
    </a>
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
              ...
              <li>
                ...
                <ul class="menu">
                  <li><!-- start message -->
                    <a href="#">
                      <div class="pull-left">
                        <img src="<?php echo e(asset('frontend')); ?>/dist/img/malvina.jpg" class="img-circle" alt="User Image">
                      </div>
                      <h4>
                        Support Team
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="<?php echo e(asset('frontend')); ?>/dist/img/malvina.jpg" class="user-image" alt="User Image">
              <span class="hidden-xs">Malvina Sania</span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
...
<nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            <a class="nav-link" href="<?php echo e(('hospice')); ?>/index.html">
...
<link href="https://cdn.jotfor.ms/css/calendarview.css?v3" rel="stylesheet" type="text/css">
<link type="text/css" rel="stylesheet" href="https://cdn.jotfor.ms/css/styles/nova.css?3">

<link type="text/css" rel="stylesheet" href="https://cdn.jotfor.ms/css/styles/payment/payment_feature.css?3">
<style type="text/css">
    .form-label-left{
        width:150px;
    }
...
<script src="https://cdn.jotfor.ms/js/prototype.js?v=3" type="text/javascript"></script>
<script src="https://cdn.jotfor.ms/js/vendor/json2.js?v=3" type="text/javascript"></script>
<script src="https://cdn.jotfor.ms/js/protoplus.js?v=3" type="text/javascript"></script>
<script src="https://cdn.jotfor.ms/js/protoplus-ui-form.js?v=3" type="text/javascript"></script>
<script src="https://cdn.jotfor.ms/js/jotform.js?v=3" type="text/javascript"></script>
<script src="https://cdn.jotfor.ms/js/calendarview.js?v=3" type="text/javascript"></script>
...
<style>html { -webkit-overflow-scrolling: touch; overflow: scroll; }body { height: 100%; overflow: scroll; }</style>
		...
		}, false);setInterval(function(){ var form = document.querySelectorAll("form.jotform-form"); if(typeof form !== "undefined" && form && form.length){ form[0].setAttribute("action", "/form-templates/preview/thank-you/classic"); form[0].setAttribute("method", "post"); } }, 1000);</script></head>
<body style="overflow: auto;">
<form class="jotform-form" action="/form-templates/preview/thank-you/classic" method="post" name="form_20864245705555" id="20864245705555" accept-charset="utf-8" autocomplete="on" novalidate="true">
  <input type="hidden" name="formID" value="20864245705555">
    ...
    <ul class="form-section page-section">
      ...
      <li class="form-line jf-required" data-type="control_textbox" id="id_4">
        ...
        <div id="cid_4" class="form-input jf-required">
          <input type="text" id="input_4" name="q4_fullName4" data-type="input-textbox" class="form-textbox validate[required]" size="30" value="" placeholder=" " data-component="textbox" aria-labelledby="label_4" required="">
        </div>
      </li>
        ...
        <div id="cid_9" class="form-input jf-required">
          <div data-wrapper-react="true">
            <span class="form-sub-label-container " style="vertical-align:top">
              <select name="q9_dateOf[day]" id="input_9_day" class="form-dropdown validate[required]" data-component="birthdate-day" aria-labelledby="label_9 sublabel_9_day">
                <option>  </option>
              ...
              <label class="form-sub-label" for="input_9_day" id="sublabel_9_day" style="min-height:13px" aria-hidden="false"> Day </label>
            </span>
            <span class="form-sub-label-container " style="vertical-align:top">
              <select name="q9_dateOf[month]" id="input_9_month" class="form-dropdown validate[required]" data-component="birthdate-month" aria-labelledby="label_9 sublabel_9_month">
                <option>  </option>
              ...
              <label class="form-sub-label" for="input_9_month" id="sublabel_9_month" style="min-height:13px" aria-hidden="false"> Month </label>
            </span>
            <span class="form-sub-label-container " style="vertical-align:top">
      </li>
      <li class="form-line" data-type="control_email" id="id_24">
        <label class="form-label form-label-left form-label-auto" id="label_24" for="input_24"> E-mail </label>
        <div id="cid_24" class="form-input">
          <input type="email" id="input_24" name="q24_emailAddress" class="form-textbox validate[Email]" size="30" value="" placeholder="nama@gmail.com" data-component="email" aria-labelledby="label_24">
        </div>
      </li>
        ...
        <div id="cid_10" class="form-input-wide jf-required">
          <div class="form-multiple-column" data-columncount="2" role="group" aria-labelledby="label_10" data-component="radio">
            ...
            <span class="form-checkbox-item" style="clear:left">
              ...
              <input type="checkbox" class="form-checkbox validate[required]" id="input_14_2" name="q14_selectWhich[]" value="Eye checkup" required="">
              <label id="label_input_14_2" for="input_14_2"> Rapid </label>
            </span>
            <span class="form-checkbox-item" style="clear:left">
              <span class="dragger-item">
              </span>
              <input type="checkbox" class="form-checkbox validate[required]" id="input_14_3" name="q14_selectWhich[]" value="Hearing Test" required="">
              <label id="label_input_14_3" for="input_14_3"> Swab </label>
            </span>
          </div>
        </div>
      </li>
      <li class="form-line" data-type="control_appointment" id="id_25">
        <label class="form-label form-label-top" id="label_25" for="input_25"> Janji</label>
        <div id="cid_25" class="form-input-wide">
          <div id="input_25" class="appointmentFieldWrapper jfQuestion-fields" data-breakpoint="shouldBreakIntoNewLine" data-breakpoint-offset="182">
            <input class="appointmentFieldInput " name="q25_appointment[date]" id="input_25_date">
            <input class="appointmentFieldInput" name="q25_appointment[duration]" value="30" id="input_25_duration">
            <input class="appointmentFieldInput" name="q25_appointment[timezone]" value="America/New_York (GMT-4:00)" id="input_25_timezone">
      ...
      <div class="selectedDate">
        <input class="currentDate" type="text" value="09/25/2020" style="pointer-events: none;">
      </div>
      
      <div class="monthYearPicker">
        <div class="pickerItem">
          <select class="pickerMonth" data-name="month">
            <option value="0">January</option><option value="1">February</option><option value="2">March</option><option value="3">April</option><option value="4">May</option><option value="5">June</option><option value="6">July</option><option value="7">August</option><option selected="" value="8">September</option><option value="9">October</option><option value="10">November</option><option value="11">December</option>
          </select>
          <button type="button" class="pickerArrow pickerMonthArrow prev" value="7" data-name="month"></button>
          <button type="button" class="pickerArrow pickerMonthArrow next" value="9" data-name="month"></button>
        </div>
        <div class="pickerItem">
          <select class="pickerYear" data-name="year">
            <option selected="">2020</option><option>2021</option><option>2022</option><option>2023</option><option>2024</option><option>2025</option><option>2026</option><option>2027</option><option>2028</option><option>2029</option><option>2030</option><option>2031</option><option>2032</option><option>2033</option><option>2034</option><option>2035</option><option>2036</option><option>2037</option><option>2038</option><option>2039</option>
          </select>
          <button type="button" class="pickerArrow pickerYearArrow prev" value="2019" data-name="year">
          </button><button type="button" class="pickerArrow pickerYearArrow next" value="2021" data-name="year">
        </button></div>
      </div>
      ...
      <div class="calendarWeek"><div class="calendarDay precedingDay empty"></div><div class="calendarDay isUnavailable" data-value="2020-09-01"><span class="calendarDayEach">1</span></div><div class="calendarDay isUnavailable" data-value="2020-09-02"><span class="calendarDayEach">2</span></div><div class="calendarDay isUnavailable" data-value="2020-09-03"><span class="calendarDayEach">3</span></div><div class="calendarDay isUnavailable" data-value="2020-09-04"><span class="calendarDayEach">4</span></div><div class="calendarDay isUnavailable" data-value="2020-09-05"><span class="calendarDayEach">5</span></div><div class="calendarDay isUnavailable" data-value="2020-09-06"><span class="calendarDayEach">6</span></div></div><div class="calendarWeek"><div class="calendarDay isUnavailable" data-value="2020-09-07"><span class="calendarDayEach">7</span></div><div class="calendarDay isUnavailable" data-value="2020-09-08"><span class="calendarDayEach">8</span></div><div class="calendarDay isUnavailable" data-value="2020-09-09"><span class="calendarDayEach">9</span></div><div class="calendarDay isUnavailable" data-value="2020-09-10"><span class="calendarDayEach">10</span></div><div class="calendarDay isUnavailable" data-value="2020-09-11"><span class="calendarDayEach">11</span></div><div class="calendarDay isUnavailable" data-value="2020-09-12"><span class="calendarDayEach">12</span></div><div class="calendarDay isUnavailable" data-value="2020-09-13"><span class="calendarDayEach">13</span></div></div><div class="calendarWeek"><div class="calendarDay isUnavailable" data-value="2020-09-14"><span class="calendarDayEach">14</span></div><div class="calendarDay isUnavailable" data-value="2020-09-15"><span class="calendarDayEach">15</span></div><div class="calendarDay isUnavailable" data-value="2020-09-16"><span class="calendarDayEach">16</span></div><div class="calendarDay isUnavailable" data-value="2020-09-17"><span class="calendarDayEach">17</span></div><div class="calendarDay isUnavailable" data-value="2020-09-18"><span class="calendarDayEach">18</span></div><div class="calendarDay isUnavailable" data-value="2020-09-19"><span class="calendarDayEach">19</span></div><div class="calendarDay isUnavailable" data-value="2020-09-20"><span class="calendarDayEach">20</span></div></div><div class="calendarWeek"><div class="calendarDay isUnavailable" data-value="2020-09-21"><span class="calendarDayEach">21</span></div><div class="calendarDay isUnavailable" data-value="2020-09-22"><span class="calendarDayEach">22</span></div><div class="calendarDay isUnavailable" data-value="2020-09-23"><span class="calendarDayEach">23</span></div><div class="calendarDay isUnavailable" data-value="2020-09-24"><span class="calendarDayEach">24</span></div><div class="calendarDay isToday isActive" data-value="2020-09-25"><span class="calendarDayEach">25</span></div><div class="calendarDay isUnavailable" data-value="2020-09-26"><span class="calendarDayEach">26</span></div><div class="calendarDay isUnavailable" data-value="2020-09-27"><span class="calendarDayEach">27</span></div></div><div class="calendarWeek"><div class="calendarDay " data-value="2020-09-28"><span class="calendarDayEach">28</span></div><div class="calendarDay " data-value="2020-09-29"><span class="calendarDayEach">29</span></div><div class="calendarDay " data-value="2020-09-30"><span class="calendarDayEach">30</span></div><div class="calendarDay trailingDay empty"></div><div class="calendarDay trailingDay empty"></div><div class="calendarDay trailingDay empty"></div><div class="calendarDay trailingDay empty"></div></div>
  ...
  <input type="hidden" class="simple_spc" id="simple_spc" name="simple_spc" value="20864245705555-20864245705555">
  <script type="text/javascript">
  var all_spc = document.querySelectorAll("form[id='20864245705555'] .si" + "mple" + "_spc");
for (var i = 0; i < all_spc.length; i++)
{
  all_spc[i].value = "20864245705555-20864245705555";
}
  </script>
<input type="hidden" name="embedUrl" value="https://www.jotform.com/form-templates/doctor-appointment-form"></form>
...
<!-- jQuery 3 -->
<script src="<?php echo e(asset('frontend')); ?>/bower_components/jquery/dist/jquery.min.js"></script>
<!-- jQuery UI 1.11.4 -->
<script src="<?php echo e(asset('frontend')); ?>/bower_components/jquery-ui/jquery-ui.min.js"></script>
<!-- Resolve conflict in jQuery UI tooltip with Bootstrap tooltip -->
<script>
  $.widget.bridge('uibutton', $.ui.button);
</script>
<!-- Bootstrap 3.3.7 -->
<script src="<?php echo e(asset('frontend')); ?>/bower_components/bootstrap/dist/js/bootstrap.min.js"></script>
<!-- Morris.js charts -->
<script src="<?php echo e(asset('frontend')); ?>/bower_components/raphael/raphael.min.js"></script>
<script src="<?php echo e(asset('frontend')); ?>/bower_components/morris.js/morris.min.js"></script>
<!-- Sparkline -->
<script src="<?php echo e(asset('frontend')); ?>/bower_components/jquery-sparkline/dist/jquery.sparkline.min.js"></script>
<!-- jvectormap -->
<script src="<?php echo e(asset('frontend')); ?>/plugins/jvectormap/jquery-jvectormap-1.2.2.min.js"></script>
<script src="<?php echo e(asset('frontend')); ?>/plugins/jvectormap/jquery-jvectormap-world-mill-en.js"></script>
<!-- jQuery Knob Chart -->
<script src="<?php echo e(asset('frontend')); ?>/bower_components/jquery-knob/dist/jquery.knob.min.js"></script>
<!-- daterangepicker -->
<script src="<?php echo e(asset('frontend')); ?>/bower_components/moment/min/moment.min.js"></script>
<script src="<?php echo e(asset('frontend')); ?>/bower_components/bootstrap-daterangepicker/daterangepicker.js"></script>
<!-- datepicker -->
<script src="<?php echo e(asset('frontend')); ?>/bower_components/bootstrap-datepicker/dist/bootstrap-daterangpicker.js"></script>
<!-- Bootstrap WYSIHTML5 -->
<script src="<?php echo e(asset('frontend')); ?>/plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.all.min.js"></script>
<!-- Slimscroll -->
<script src="<?php echo e(asset('frontend')); ?>/bower_components/jquery-slimscroll/jquery.slimscroll.min.js"></script>
<!-- FastClick -->
<script src="<?php echo e(asset('frontend')); ?>/bower_components/fastclick/lib/fastclick.js"></script>
<!-- AdminLTE App -->
<script src="<?php echo e(asset('frontend')); ?>/dist/js/adminlte.min.js"></script>
<!-- AdminLTE dashboard demo (This is only for demo purposes) -->
<script src="<?php echo e(asset('frontend')); ?>/dist/js/pages/dashboard.js"></script>
<!-- AdminLTE for demo purposes -->
<script src="<?php echo e(asset('frontend')); ?>/dist/js/demo.js"></script>
</body>
</html>
<?php /**PATH C:\xampp\htdocs\malvinasania\resources\views/layouts/master.blade.php ENDPATH**/ ?>